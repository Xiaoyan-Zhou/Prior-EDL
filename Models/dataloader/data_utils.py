def set_up_datasets(args):
    if args.dataset == 'miniimagenet':
        ...
        if args.sample_flag:
            from Models.dataloader.MSTAR.dataloader_mstar import DatasetLoader_sample as Dataset
        else:
            from Models.dataloader.MSTAR.dataloader_mstar import DatasetLoader as Dataset
    else:
